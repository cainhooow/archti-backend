...
use crate::m20260321_173415_create_table_resources::Resource;
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let mut resource_fk = ForeignKey::create()
            .from(ResourceMachine::Table, ResourceMachine::ResourceId)
